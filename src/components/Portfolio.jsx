...
const PortfolioCard = ({ image, alt, category, title, description, index }) => {
  const cardVariants = {
    ...
    >
      ...
      >
       ...
       <motion.button
        ...
        <div className="absolute border w-[541px] h-[206px] rotate[-30deg] -bottom-30 -left-80 bg-[rgba(190,41,215,0.5)] blur-[100px] -z-1"></div>
        <div className="absolute border w-[541px] h-[206px] rotate[-30deg] -bottom-10 -right-90 bg-[rgba(26,94,77,0.7)] blur-[100px] -z-1"></div>
    </motion.div>
  );
}
