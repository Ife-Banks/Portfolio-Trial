...
function Contact() {
  ...
  return (
    <div className="w-[60%] border border-[#474C54] mx-auto lg:-mb-40 p-5 flex flex-col gap-5 rounded-2xl relative bg-black/20 backdrop-blur-sm shadow-[0_8px_32px_rgba(255,255,255,0.2)]
">
       <div 
        ref={bg1Ref}
        className="absolute w-100 h-[600px] lg:w-[100px] lg:h-[800px] border rotate-[-100deg] -top-50 right-full lg:-top-25 lg:right-1/2 lg:translate-x-1/2 transition-all duration-500 blur-[150px] -z-1" 
        ></div>
      <main className='flex items-center justify-evenly'>
        ...
        <ul className='flex flex-col gap-5 border-white w-[30%] p-2 text-white'>
          <li className='flex flex-col '>
            <h1 className='font-workSan text-lg font-medium'>Email:</h1>
            <span className='font-IBM italic text-sm -mt-1'>Ifeoluwa.bankole05@gmail.com</span>
          </li>
           <li className='flex flex-col'>
            <h1 className='font-workSan text-lg font-medium'>Phone No:</h1>
            <span className='font-IBM italic text-sm -mt-1'>+234 706 777 0855</span>
          </li>
        </ul>
      </main>
      <ContactForm/>
