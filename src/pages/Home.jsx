...
const Home = () => {
    ...
    useEffect(() => {
        ...
        const changeColors = () => {
            ...
            if (bg1Ref.current) {
                bg1Ref.current.style.backgroundColor = colors[randomIndex1];
            }
            if (bg2Ref.current) {
                bg2Ref.current.style.backgroundColor = colors[randomIndex2];
            }
        };
        ...
        <div className="bg-[#2A2C38] relative z-0" id="three">
            <main className="bg-[#2A2C38] relative" id="two">
                <div className="" id="one">
                    ...
                    <div 
                        ref={bg1Ref}
                        className="absolute w-[871.213px] h-[871.213px] border rotate-[-130deg] -top-100 -right-160 transition-all duration-500 blur-[300px]" 
                    ></div>
                    <div 
                        ref={bg2Ref}
